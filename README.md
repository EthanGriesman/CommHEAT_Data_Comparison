...
## CommHEAT Output Directory Structure

This directory contains all processed data products, statistical summaries, and visualizations generated by the CommHEAT analysis pipeline.
...
- **hobo_data_processed/**
  - HOBO logger data cleaned and converted to Celsius.

- **mse_statistics/**
  - Mean Squared Error (MSE) statistics quantifying model–measurement agreement.

- **plots/**
  - **ac_noac_period_intersection/**
    - Comparisons between air-conditioned (AC) and non-AC periods per address over overlapping time windows.
  - **entire_pilot_period/**
  ...
  - **period_intersection_no_archetypes/**
    - Period-intersection plots without archetype separation.

- **HoboHouseIndex.xlsx**
  - Master index linking HOBO sensor IDs to household and archetype metadata.
